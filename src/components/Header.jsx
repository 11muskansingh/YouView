    ...
    <div className="sticky top-0 z-10 flex flex-row items-center justify-between h-16 px-4 md:px-5 bg-white dark:bg-black">
      <div className="flex h-5 items-center">
        ...
        <div onClick={toggleSideBar}>
          {isSideBarVisible ? (
            <CgClose className="text-white text-xl mr-8 hover:opacity-70 transition-opacity cursor-pointer" />
          ) : (
            <SlMenu className="text-white text-xl mr-8 hover:opacity-70 transition-opacity cursor-pointer" />
          )}
        </div>
